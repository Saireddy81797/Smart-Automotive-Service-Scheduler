...
st.sidebar.markdown('<div class="sidebar-title">🚗 Smart Scheduler</div>', unsafe_allow_html=True)
...
<div class="gradient-header">
  <div style="display:flex;justify-content:space-between;align-items:center;">
    <div style="font-weight:800;font-size:20px;">Smart Automotive Scheduler</div>
...
# ------------------- ROUTING -------------------
# ✅ Admin page now opens directly WITHOUT password
if nav.startswith("👤"):
    customer.render()
else:
    admin.render()
